	...
	var ScrollRefresh = function (_React$Component) {
	  ...
	  _createClass(ScrollRefresh, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      if (!this.props.synch) {
	        if (!_lodash2.default.isEqual(nextProps.nextData, this.props.nextData)) {
	          this.setNextData(nextProps.nextData);
	        } else if (_lodash2.default.isEmpty(nextProps.nextData) && this.state.loading) {
	    ...
	    value: function setNextData(nextData) {
	      ...
	      if (!_lodash2.default.isEmpty(nextData)) {
