...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScrollRefresh = function (_React$Component) {
	  ...
	  _createClass(ScrollRefresh, [{
	    ...
	    value: function render() {
	      ...
	      if ((0, _isempty2.default)(this.state.data)) {
	        return this.props.renderNoData ? this.props.renderNoData() : null;
	      } else {
	        return _react2.default.createElement(this.props.wrapper || 'div', {
	    ...
	    value: function renderItem(item, index) {
	      return this.props.renderItem ? this.props.renderItem(item, index) : _react2.default.createElement(
	        'div',
	        { key: index },
	        item
	      );
	    ...
	    value: function fetchNextData() {
	      ...
	      if (!this.loading) {
	        ...
	        var nextData = this.props.fetchNextData(reset ? 0 : this.state.currentPos, reset ? 1 : this.state.pageNo);
	        if (this.props.synch) {
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      if (!this.props.synch) {
	        if (!(0, _isequal2.default)(nextProps.nextData, this.props.nextData)) {
	          // 这里通过null来清空nextData
	          if (nextProps.nextData !== null) {
	            this.setNextData(nextProps.nextData);
	          }
	        } else if ((0, _isempty2.default)(nextProps.nextData) && this.loading) {
	    ...
	    value: function setNextData(nextData) {
	      ...
	      if (!(0, _isempty2.default)(nextData)) {
	        if (reset) {
	...
	ScrollRefresh.propTypes = {
	  fetchNextData: _propTypes2.default.func.isRequired
	};
